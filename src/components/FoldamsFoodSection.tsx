...
export default function FoldamsFoodSection() {
  // Set the launch date for Foldams Food (6 months from current date)
  ...
  const dialogTitle = dialogType === "products" 
    ? "Foldams Food Product Launch" 
    : "The Foldams Food Story";

  const dialogDescription = dialogType === "products"
    ? "Be among the first to taste our authentic African and Caribbean delicacies. Pre-order now!"
    : "Learn about our mission to bring African and Caribbean agricultural excellence to the world.";

  return (
    <section id="foldams-food" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Foldams Food</h2>
            <div className="w-24 h-1 bg-foldams-red mx-auto mb-6"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Bringing the authentic tastes of Africa and the Caribbean to the world through our premium farm products and diverse cuisines.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-6">
                At Foldams Food, we're passionate about sharing the rich flavors and nutritional benefits of authentic African and Caribbean cuisines with the world. Our products are sourced directly from sustainable farms across Africa and the Caribbean islands, bringing you the best of both regions' culinary traditions.
              </p>
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-center">
                  ...
                  Premium African & Caribbean Spices & Seasonings
                </li>
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-foldams-red mr-3" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <li className="flex items-center">
                  ...
                  Traditional Herbal Teas & Infusions
                </li>
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-foldams-red mr-3" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  Ready-to-Cook Authentic Meal Kits
                </li>
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-foldams-red mr-3" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  Gourmet African & Caribbean Snacks
                </li>
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-foldams-red mr-3" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  Caribbean Sauces & Condiments
                </li>
              </ul>
          ...
          <div className="mt-20">
            <h3 className="text-2xl font-bold text-center mb-8">The Foldams Food Difference</h3>
